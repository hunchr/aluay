...
function html(...$files) { // TODO: Lang
    ...
    <meta name="keywords" content="aluay,'.$l[0].','.$l[2].'">
    ...
    implode('', array_map(function($path) {
        global $nonce;
        return // TODO: <link rel="preload" href="/css/'.$path.'.css" as="style" nonce="'.$nonce.'" onload="this.onload=null;this.rel=\'stylesheet\'">
    ...
    <body>
    <nav>
        <button id="back" data-f="_A" aria-label="Back">
            <img src="/img/apple-touch-icon.png" alt="Logo" loading="lazy" width="24">
        ...
        <div id="bnav">
            ...
            <button aria-label="Create post"><svg viewBox="0 0 8 8"><path d="M8 3.5H4.5V0h-1v3.5H0v1h3.5V8h1V4.5H8v-1z"/></svg></button>
            ...
            <button data-f="_C" aria-label="Menu"><img src="/uc/s/'.$uid.'/0.webp" alt="Profile picture" loading="lazy" width="24"></button>
        </div>
    ...
    <div id="side" class="hidden">
        <menu></menu>
        <menu>
            <button><img src="/uc/s/'.$uid.'/0.webp" alt="Profile picture" loading="lazy" width="24"><span>username</span><svg viewBox="0 0 4 8"><path d="M0 3.5 2 0l2 3.5H0zM4 4.5 2 8 0 4.5h4z"/></svg></button>
        </menu>
    </div>
    <div id="main">
        '.$main.'
    ...
    <footer class="center">
        ...
        <button class="a" data-f="__" data-n="privacy-policy">Privacy Policy</button>
        <button class="a" data-f="__" data-n="terms">Terms</button>
    </footer>
    </body>
    </html>'
    );
